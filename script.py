...
def runIperf(net, iteration) :
    ...
    #vh2_command = 'iperf -u -c {} -b 1M -l {} -i 1 > udp_client.txt &'.format(vh1.IP(), tcpPacketLength)
    print(vh2_command)
    vh1.cmd('iperf -u -s -i 10 > udp_server.txt &')
    vh3.cmd('iperf -s -w 1M -Z cubic -i 10 > tcp_server.txt &')
    ...
    vh4.cmd('iperf -c {} -w 1M -Z cubic -i 10 > tcp_client.txt &'.format(vh3.IP()))
    time.sleep(12)
